...
// музыки в локации. Опрашивается фронтендом отдельным, более частым таймером
// (~2 сек), чем сообщения (4 сек) - см. START_BUFFER_MS в
// club-playback-start.js/club-playback-ready.js.
