...
export async function onRequestDelete(context) {
  ...
  try {
    await env.DB.batch([
      ...
      env.DB.prepare("DELETE FROM club_character_choice WHERE club_id = ?").bind(id),
      env.DB.prepare("DELETE FROM club_checkins WHERE club_id = ?").bind(id),
      env.DB.prepare("DELETE FROM club_attention_dismissed WHERE club_id = ?").bind(id),
