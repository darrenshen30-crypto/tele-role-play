// functions/api/dm-read.js — отметить личную переписку прочитанной до
...
export async function onRequestPost(context) {
  ...
  try {
    await env.DB.prepare(
      "INSERT INTO dm_reads (thread_id, user_id, last_read_message_id) VALUES (?, ?, ?) " +
    ...
    console.log("Ошибка отметки прочтения личной переписки:", e.message);
